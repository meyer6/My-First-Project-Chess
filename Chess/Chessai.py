...
stockfish = Stockfish(r"C:\Users\meyer\AppData\Local\Programs\Python\Python39\Lib\site-packages")
pygame.init()
...
while run:
    for event in pygame.event.get():
            ...
            for a in range (0,8):
                if Board[i][a][0]!="":
                    if s!=0:
                        fen=fen+(str(s))
                        s=0
                    if (Board[i][a][0])[0]=="b" and Board[i][a][1]=="w":
                        fen=fen+"B"
                    elif (Board[i][a][0])[0]=="b" and Board[i][a][1]=="b":
                        fen=fen+"b"
                    elif (Board[i][a][0])[0]=="r" and Board[i][a][1]=="w":
                        fen=fen+"R"
                    elif (Board[i][a][0])[0]=="r" and Board[i][a][1]=="b":
                        fen=fen+"r"
                    elif (Board[i][a][0])[0]=="kn" and Board[i][a][1]=="w":
                        fen=fen+"N"
                    elif (Board[i][a][0])[0]=="kn" and Board[i][a][1]=="b":
                        fen=fen+"n"
                    elif (Board[i][a][0])[0]=="q" and Board[i][a][1]=="w":
                        fen=fen+"Q"
                    elif (Board[i][a][0])[0]=="q" and Board[i][a][1]=="b":
                        fen=fen+"q"
                    elif (Board[i][a][0])[0]=="p" and Board[i][a][1]=="w":
                        fen=fen+"P"
                    elif (Board[i][a][0])[0]=="p" and Board[i][a][1]=="b":
                        fen=fen+"p"
                    elif (Board[i][a][0])[0]=="k" and Board[i][a][1]=="w":
                        fen=fen+"K"
                    elif (Board[i][a][0])[0]=="k" and Board[i][a][1]=="b":
                        fen=fen+"k"
                else:
                    s=s+1
                    if a==7 and s!=0:
        ...
        if moves==0:
            ...
            if moves_backup!=moves:
                overall_moves=overall_moves+1
        moves_backup=moves
        if moves==1:
            if event3.type==pygame.MOUSEBUTTONDOWN and rfv!=1:
                if piece=="":
