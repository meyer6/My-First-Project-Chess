...
while run:
    for event in pygame.event.get():
        ...
        if two_protectors==False and piece!="":
            coords4=[]
            if piece[len(piece)-1]!="b":
                if piece[1]=="n":
                    vc=piece[0]+piece[1]+piece[len(piece)-1]+"w"
                else:
                    vc=piece[0]+piece[len(piece)-1]+"w"
            else:
                if piece[1]=="n":
                    vc=piece[0]+piece[1]+piece[len(piece)-1]+"b"
                else:
                    vc=piece[0]+piece[len(piece)-1]+"b"
            if piece[len(piece)-1]=="b":
