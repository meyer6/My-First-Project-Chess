            ...
            if event.key==pygame.K_SPACE:
                ...
                if roomx==self.coords2[0][0] and roomy==self.coords2[0][1]:
                    ...
                    for k1 in range (0, len(self.coords)):
                        roomx,roomy=pygame.mouse.get_pos()
                        roomx=(roomx-roomx%60)+30
                        roomy=(roomy-roomy%60)+30
...
#############################################################################
        if moves==1:
            ...
            if piece=="bishop1b":
                ...
                if tg==2:
                    hw,white_check,moves=0,False,moves+1
                if tg==3 or tg==2 or tg==1:
            ...
            if piece=="rook1b":
                ...
                if tg==2:
                    hw,white_check,moves,moves2r1b=0,False,moves+1,1
                if tg==3 or tg==2 or tg==1:
            ...
            if piece=="rook2b":
                ...
                if tg==2:
                    hw,white_check,moves,moves2r2b=0,False,moves+1,1
                if tg==3 or tg==2 or tg==1:
            ...
            if piece=="rook3b":
                ...
                if tg==2:
                    hw,white_check,moves,moves2r3b=0,False,moves+1,1
                if tg==3 or tg==2 or tg==1:
            ...
            if piece=="rook4b":
                ...
                if tg==2:
                    hw,white_check,moves,moves2r4b=0,False,moves+1,1
                if tg==3 or tg==2 or tg==1:
            ...
            if piece=="rook5b":
                ...
                if tg==2:
                    hw,white_check,moves,moves2r5b=0,False,moves+1,1
                if tg==3 or tg==2 or tg==1:
            ...
            if piece=="pawn1b":
                ...
                if tg==2:
                    hw,white_check,moves,moves21b=0,False,moves+1,moves21b+1
                if tg==3 or tg==2 or tg==1:
            ...
            if piece=="pawn2b":
                ...
                if tg==2:
                    hw,white_check,moves,moves22b=0,False,moves+1,moves22b+1
                if tg==3 or tg==2 or tg==1:
            ...
            if piece=="pawn3b":
                ...
                if tg==2:
                    hw,white_check,moves,moves23b=0,False,moves+1,moves23b+1
                if tg==3 or tg==2 or tg==1:
            ...
            if piece=="pawn4b":
                ...
                if tg==2:
                    hw,white_check,moves,moves24b=0,False,moves+1,moves24b+1
                if tg==3 or tg==2 or tg==1:
            ...
            if piece=="pawn5b":
                ...
                if tg==2:
                    hw,white_check,moves,moves25b=0,False,moves+1,moves25b+1
                if tg==3 or tg==2 or tg==1:
            ...
            if piece=="pawn6b":
                ...
                if tg==2:
                    hw,white_check,moves,moves26b=0,False,moves+1,moves26b+1
                if tg==3 or tg==2 or tg==1:
            ...
            if piece=="pawn7b":
                ...
                if tg==2:
                    hw,white_check,moves,moves27b=0,False,moves+1,moves27b+1
                if tg==3 or tg==2 or tg==1:
            ...
            if piece=="pawn8b":
                ...
                if tg==2:
                    hw,white_check,moves,moves28b=0,False,moves+1,moves28b+1
                if tg==3 or tg==2 or tg==1:
