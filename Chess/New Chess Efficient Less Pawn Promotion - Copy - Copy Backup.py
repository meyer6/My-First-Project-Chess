                ...
                if two_protectors==False:
                    ...
                    if self.colour=="w":
                        for i in range (0,len(black_protector)):
                            if black_protector[i][0]==self.number:
                    ...
                    if self.colour=="b":
                        for i in range (0,len(white_protector)):
                            if white_protector[i][0]==self.number:
                                for a in range(0,len(self.coords)):
...
class pawnw(bishopw):
    def __init__(self,coords,coords2,bwmx,bwmy,number,colour,moves2):
        ...
        self.colour=colour
        self.moves2=moves2    
    def possible_moves(self,coords,coords2,colour,moves2,piece_backup,Checkmate_pass):
        self.colour=colour
        self.Checkmate_pass=Checkmate_pass
        yposition=list_searchy(Board,self.number)
        xposition=list_searchx(Board,self.number)
        ...
        if yposition!=9 or xposition!=9:
            ...
            if self.vc[0]=="q" or self.vc[0]=="b":
                while jk==False:
                    ...
                    if (yposition+i)<8 and (xposition+i)<8 and (yposition+i)>-1 and (xposition+i)>-1 and Board[(yposition+i)][(xposition+i)][0]=="" :
                        pos_spaces.append([(xposition+i)*60,(yposition+i)*60])
                        self.q11.append([((xposition+i)*60),((yposition+i)*60)])
                    else:
                        jk=True
                        if (yposition+i)<8 and (xposition+i)<8 and (yposition+i)>-1 and (xposition+i)>-1 and Board[(yposition+i)][(xposition+i)][1]==self.colour:
                            self.q11.append([((xposition+i)*60),((yposition+i)*60)])
                            piece2,jk=Board[(yposition+i)][(xposition+i)][0],False
                            while jk==False:
                                jk,a=True,a+1
                                pos_spaces.append([(xposition+i+a)*60,(yposition+i+a)*60])
                                if (yposition+i+a)<8 and (xposition+i+a)<8 and (yposition+i+a)>-1 and (xposition+i+a)>-1 and Board[(yposition+i+a)][(xposition+i+a)][0]==self.king:
                                    for z in range(0,len(pos_spaces)):
                                        black_protector.append([piece2,pos_spaces[z][0],pos_spaces[z][1]])
                                elif (yposition+i+a)<8 and (xposition+i+a)<8 and (yposition+i+a)>-1 and (xposition+i+a)>-1 and Board[(yposition+i+a)][(xposition+i+a)][1]==self.colour:
                                    two_protectors=True
                                    jk=False
                        elif (yposition+i)<8 and (xposition+i)<8 and (yposition+i)>-1 and (xposition+i)>-1 and Board[(yposition+i)][(xposition+i)][1]==self.colour2:
                            self.q11.append([((xposition+i)*60),((yposition+i)*60)])
                i,a,pos_spaces=0,0,[]
                while jk==True:
                    i=i-1
                    ...
                    if (yposition+i)<8 and (xposition+i)<8 and (yposition+i)>-1 and (xposition+i)>-1 and Board[(yposition+i)][(xposition+i)][0]=="" :
                        pos_spaces.append([(xposition+i)*60,(yposition+i)*60])
                        self.q12.append([((xposition+i)*60),((yposition+i)*60)])
                    else:
                        jk=False
                        if (yposition+i)<8 and (xposition+i)<8 and (yposition+i)>-1 and (xposition+i)>-1 and Board[(yposition+i)][(xposition+i)][1]==self.colour:
                            self.q12.append([((xposition+i)*60),((yposition+i)*60)])
                            piece2,jk=Board[(yposition+i)][(xposition+i)][0],True
                            while jk==True:
                                jk,a=False,a-1
                                pos_spaces.append([(xposition+i+a)*60,(yposition+i+a)*60])
                                if (yposition+i+a)<8 and (xposition+i+a)<8 and (yposition+i+a)>-1 and (xposition+i+a)>-1 and Board[(yposition+i+a)][(xposition+i+a)][0]==self.king:
                ...
                while jk==False:
                    ...
                    if (yposition-i)<8 and (xposition+i)<8 and (yposition-i)>-1 and (xposition+i)>-1 and Board[(yposition-i)][(xposition+i)][0]=="" :
                        pos_spaces.append([(xposition+i)*60,(yposition-i)*60])
                        self.q13.append([((xposition+i)*60),((yposition-i)*60)])
                    else:
                        jk=True
                        if (yposition-i)<8 and (xposition+i)<8 and (yposition-i)>-1 and (xposition+i)>-1 and Board[(yposition-i)][(xposition+i)][1]==self.colour:
                            self.q13.append([((xposition+i)*60),((yposition-i)*60)])
                ...
                while jk==True:
                    ...
                    if (yposition+i)<8 and (xposition-i)<8 and (yposition+i)>-1 and (xposition-i)>-1 and Board[(yposition+i)][(xposition-i)][0]=="" :
                        pos_spaces.append([(xposition-i)*60,(yposition+i)*60])
                        self.q14.append([((xposition-i)*60),((yposition+i)*60)])
                    else:
                        jk=False
                        if (yposition+i)<8 and (xposition-i)<8 and (yposition+i)>-1 and (xposition-i)>-1 and Board[(yposition+i)][(xposition-i)][1]==self.colour:
                            self.q14.append([((xposition-i)*60),((yposition+i)*60)])
            ...
            if self.vc[0]=="q" or self.vc[0]=="r":
                ...
                while jk==False:
                    i=i+1
                    pos_spaces.append([xposition*60,yposition*60])
                    if (yposition+i)<8 and (xposition)<8 and (yposition+i)>-1 and (xposition)>-1 and Board[(yposition+i)][(xposition)][0]=="" :
                        pos_spaces.append([(xposition)*60,(yposition+i)*60])
                        self.q15.append([((xposition)*60),((yposition+i)*60)])
                    else:
                        jk=True
                        if (yposition+i)<8 and (xposition)<8 and (yposition+i)>-1 and (xposition)>-1 and Board[(yposition+i)][(xposition)][1]==self.colour:
                            self.q15.append([((xposition)*60),((yposition+i)*60)])
                            piece2,jk=Board[(yposition+i)][(xposition)][0],False
                            while jk==False:
                                jk,a=True,a+1
                                pos_spaces.append([(xposition)*60,(yposition+i+a)*60])
                                if (yposition+i+a)<8 and (xposition)<8 and (yposition+i+a)>-1 and (xposition)>-1 and Board[(yposition+i+a)][(xposition)][0]==self.king:
                                    for z in range(0,len(pos_spaces)):
                                        black_protector.append([piece2,pos_spaces[z][0],pos_spaces[z][1]])
                                elif (yposition+i+a)<8 and (xposition)<8 and (yposition+i+a)>-1 and (xposition)>-1 and Board[(yposition+i+a)][(xposition)][1]==self.colour:
                                    two_protectors=True
                                    jk=False
                        elif (yposition+i)<8 and (xposition)<8 and (yposition+i)>-1 and (xposition)>-1 and Board[(yposition+i)][(xposition)][1]==self.colour2:
                            self.q15.append([((xposition)*60),((yposition+i)*60)])
                i,a,pos_spaces=0,0,[]
                while jk==True:
                    i=i+1
                    ...
                    if (yposition-i)<8 and (xposition)<8 and (yposition-i)>-1 and (xposition)>-1 and Board[(yposition-i)][(xposition)][0]=="" :
                        pos_spaces.append([(xposition)*60,(yposition-i)*60])
                        self.q16.append([((xposition)*60),((yposition-i)*60)])
                    else:
                        jk=False
                        if (yposition-i)<8 and (xposition)<8 and (yposition-i)>-1 and (xposition)>-1 and Board[(yposition-i)][(xposition)][1]==self.colour:
                            self.q16.append([((xposition)*60),((yposition-i)*60)])
                            piece2,jk=Board[(yposition-i)][(xposition)][0],True
                            while jk==True:
                                jk,a=False,a+1
                                pos_spaces.append([(xposition)*60,(yposition-i-a)*60])
                                if (yposition-i-a)<8 and (xposition)<8 and (yposition-i-a)>-1 and (xposition)>-1 and Board[(yposition-i-a)][(xposition)][0]==self.king:
                ...
                while jk==False:
                    i=i+1
                    pos_spaces.append([xposition*60,yposition*60])
                    if (yposition)<8 and (xposition+i)<8 and (yposition)>-1 and (xposition+i)>-1 and Board[(yposition)][(xposition+i)][0]=="" :
                        pos_spaces.append([(xposition+i)*60,(yposition)*60])
                        self.q17.append([((xposition+i)*60),((yposition)*60)])
                    else:
                        jk=True
                        if (yposition)<8 and (xposition+i)<8 and (yposition)>-1 and (xposition+i)>-1 and Board[(yposition)][(xposition+i)][1]==self.colour:
                            self.q17.append([((xposition+i)*60),((yposition)*60)])
                            piece2,jk=Board[(yposition)][(xposition+i)][0],False
                            while jk==False:
                                jk,a=True,a+1
                                pos_spaces.append([(xposition+i+a)*60,(yposition)*60])
                                if (yposition)<8 and (xposition+i+a)<8 and (yposition)>-1 and (xposition+i+a)>-1 and Board[(yposition)][(xposition+i+a)][0]==self.king:
                                    for z in range(0,len(pos_spaces)):
                                        black_protector.append([piece2,pos_spaces[z][0],pos_spaces[z][1]])
                                elif (yposition)<8 and (xposition+i+a)<8 and (yposition)>-1 and (xposition+i+a)>-1 and Board[(yposition)][(xposition+i+a)][1]==self.colour:
                                    two_protectors=True
                                    jk=False
                        elif (yposition)<8 and (xposition+i)<8 and (yposition)>-1 and (xposition+i)>-1 and Board[(yposition)][(xposition+i)][1]==self.colour2:
                            self.q17.append([((xposition+i)*60),((yposition)*60)])
                i,a,pos_spaces=0,0,[]
                while jk==True:
                    i=i+1
                    ...
                    if (yposition)<8 and (xposition-i)<8 and (yposition)>-1 and (xposition-i)>-1 and Board[(yposition)][(xposition-i)][0]=="" :
                        pos_spaces.append([(xposition-i)*60,(yposition)*60])
                        self.q18.append([((xposition-i)*60),((yposition)*60)])
                    else:
                        jk=False
                        if (yposition)<8 and (xposition-i)<8 and (yposition)>-1 and (xposition-i)>-1 and Board[(yposition)][(xposition-i)][1]==self.colour:
                            self.q18.append([((xposition-i)*60),((yposition)*60)])
                            piece2,jk=Board[(yposition)][(xposition-i)][0],True
                            while jk==True:
                                jk,a=False,a+1
                                pos_spaces.append([(xposition-i-a)*60,(yposition)*60])
                                if (yposition)<8 and ((xposition-i)-a)<8 and (yposition)>-1 and ((xposition-i)-a)>-1 and Board[(yposition)][((xposition-i)-a)][0]==self.king:
...
class knight1(object):
    ...
    def check(self,kn1,black_protector,vc,king,colour,colour2):
        ...
        if xposition!=9:
            if (2+yposition)<8 and (xposition-1)<8 and (2+yposition)>-1 and (xposition-1)>-1 and (2+yposition)>-1 and (xposition-1)>-1 and  (2+yposition)<8 and (xposition-1)<8  and Board[(2+yposition)][(xposition-1)][0]=="" :
                self.kn1.append([(xposition-1)*60,(2+yposition)*60])
            else:
                if (2+yposition)<8 and (xposition-1)<8 and (2+yposition)>-1 and (xposition-1)>-1 and  (2+yposition)>-1 and (xposition-1)>-1 and  (2+yposition)<8 and (xposition-1)<8  and Board[(2+yposition)][(xposition-1)][1]==self.colour or 2+yposition<8 and xposition-1<8 and 2+yposition>-1 and xposition-1>-1 and Board[2+yposition][xposition-1][1]==self.colour2:
                    self.kn1.append([(xposition-1)*60,(2+yposition)*60])
            if (yposition+2)<8 and (xposition+1)<8 and (yposition+2)>-1 and (xposition+1)>-1 and (yposition+2)>-1 and (xposition+1)>-1 and  (yposition+2)<8 and (xposition+1)<8  and Board[(yposition+2)][(xposition+1)][0]=="" :
                self.kn1.append([(xposition+1)*60,(yposition+2)*60])
            else:
                if (yposition+2)<8 and (xposition+1)<8 and (yposition+2)>-1 and (xposition+1)>-1 and  (yposition+2)>-1 and (xposition+1)>-1 and  (yposition+2)<8 and (xposition+1)<8  and Board[(yposition+2)][(xposition+1)][1]==self.colour or yposition+2<8 and xposition+1<8 and yposition+2>-1 and xposition+1>-1 and Board[yposition+2][xposition+1][1]==self.colour2:
                    self.kn1.append([(xposition+1)*60,(yposition+2)*60])
            if (yposition-2)<8 and (xposition+1)<8 and (yposition-2)>-1 and (xposition+1)>-1 and (yposition-2)>-1 and (xposition+1)>-1 and  (yposition-2)<8 and (xposition+1)<8  and Board[(yposition-2)][(xposition+1)][0]=="" :
                self.kn1.append([(xposition+1)*60,(yposition-2)*60])
            else:
            ...
            if (yposition-2)<8 and (xposition-1)<8 and (yposition-2)>-1 and (xposition-1)>-1 and (yposition-2)>-1 and (xposition-1)>-1 and  (yposition-2)<8 and (xposition-1)<8  and Board[(yposition-2)][(xposition-1)][0]=="" :
                ...
                if (yposition-2)<8 and (xposition-1)<8 and (yposition-2)>-1 and (xposition-1)>-1 and  (yposition-2)>-1 and (xposition-1)>-1 and  (yposition-2)<8 and (xposition-1)<8  and Board[(yposition-2)][(xposition-1)][1]==self.colour or yposition-2<8 and xposition-1<8 and yposition-2>-1 and xposition-1>-1 and Board[yposition-2][xposition-1][1]==self.colour2:
                    self.kn1.append([(xposition-1)*60,(yposition-2)*60])
            if (yposition-1)<8 and (xposition-2)<8 and (yposition-1)>-1 and (xposition-2)>-1 and (yposition-1)>-1 and (xposition-2)>-1 and  (yposition-1)<8 and (xposition-2)<8  and Board[(yposition-1)][(xposition-2)][0]=="" :
                self.kn1.append([(xposition-2)*60,(yposition-1)*60])
            else:
                if (yposition-1)<8 and (xposition-2)<8 and (yposition-1)>-1 and (xposition-2)>-1 and  (yposition-1)>-1 and (xposition-2)>-1 and  (yposition-1)<8 and (xposition-2)<8  and Board[(yposition-1)][(xposition-2)][1]==self.colour or yposition-1<8 and xposition-2<8 and yposition-1>-1 and xposition-2>-1 and Board[yposition-1][xposition-2][1]==self.colour2:
                    self.kn1.append([(xposition-2)*60,(yposition-1)*60])
            if (yposition+1)<8 and (xposition-2)<8 and (yposition+1)>-1 and (xposition-2)>-1 and (yposition+1)>-1 and (xposition-2)>-1 and  (yposition+1)<8 and (xposition-2)<8  and Board[(yposition+1)][(xposition-2)][0]=="" :
                self.kn1.append([(xposition-2)*60,(yposition+1)*60])
            else:
...
class king1(object):
    ...
    def check(self,k1w,vc,colour,colour2):
        ...
        xposition=list_searchx(Board,vc)
        if xposition!=9:
            if (1+yposition)<8 and (xposition)<8 and (1+yposition)>-1 and (xposition)>-1 and (1+yposition)>-1 and (xposition)>-1 and  (1+yposition)<8 and (xposition)<8  and Board[(1+yposition)][(xposition)][0]=="" :
                self.k1w.append([(xposition)*60,(1+yposition)*60])
            else:
                if (1+yposition)<8 and (xposition)<8 and (1+yposition)>-1 and (xposition)>-1 and  (1+yposition)>-1 and (xposition)>-1 and  (1+yposition)<8 and (xposition)<8  and Board[(1+yposition)][(xposition)][1]==self.colour or 1+yposition<8 and xposition<8 and 1+yposition>-1 and xposition>-1 and Board[1+yposition][xposition][1]==self.colour2:
                    self.k1w.append([(xposition)*60,(1+yposition)*60])
            if (yposition-1)<8 and (xposition)<8 and (yposition-1)>-1 and (xposition)>-1 and (yposition-1)>-1 and (xposition)>-1 and  (yposition-1)<8 and (xposition)<8  and Board[(yposition-1)][(xposition)][0]=="" :
                self.k1w.append([(xposition)*60,(yposition-1)*60])
            else:
                if (yposition-1)<8 and (xposition)<8 and (yposition-1)>-1 and (xposition)>-1 and  (yposition-1)>-1 and (xposition)>-1 and  (yposition-1)<8 and (xposition)<8  and Board[(yposition-1)][(xposition)][1]==self.colour or yposition-1<8 and xposition<8 and yposition-1>-1 and xposition>-1 and Board[yposition-1][xposition][1]==self.colour2:
                    self.k1w.append([(xposition)*60,(yposition-1)*60])
            if (yposition)<8 and (xposition-1)<8 and (yposition)>-1 and (xposition-1)>-1 and (yposition)>-1 and (xposition-1)>-1 and  (yposition)<8 and (xposition-1)<8  and Board[(yposition)][(xposition-1)][0]=="" :
                self.k1w.append([(xposition-1)*60,(yposition)*60])
            else:
                if (yposition)<8 and (xposition-1)<8 and (yposition)>-1 and (xposition-1)>-1 and  (yposition)>-1 and (xposition-1)>-1 and  (yposition)<8 and (xposition-1)<8  and Board[(yposition)][(xposition-1)][1]==self.colour or yposition<8 and xposition-1<8 and yposition>-1 and xposition-1>-1 and Board[yposition][xposition-1][1]==self.colour2:
                    self.k1w.append([(xposition-1)*60,(yposition)*60])
            if (yposition)<8 and (xposition+1)<8 and (yposition)>-1 and (xposition+1)>-1 and (yposition)>-1 and (xposition+1)>-1 and  (yposition)<8 and (xposition+1)<8  and Board[(yposition)][(xposition+1)][0]=="" :
                self.k1w.append([(xposition+1)*60,(yposition)*60])
            else:
                if (yposition)<8 and (xposition+1)<8 and (yposition)>-1 and (xposition+1)>-1 and  (yposition)>-1 and (xposition+1)>-1 and  (yposition)<8 and (xposition+1)<8  and Board[(yposition)][(xposition+1)][1]==self.colour or yposition<8 and xposition+1<8 and yposition>-1 and xposition+1>-1 and Board[yposition][xposition+1][1]==self.colour2:
                    self.k1w.append([(xposition+1)*60,(yposition)*60])                    
            if (1+yposition)<8 and (xposition+1)<8 and (1+yposition)>-1 and (xposition+1)>-1 and (1+yposition)>-1 and (xposition+1)>-1 and  (1+yposition)<8 and (xposition+1)<8  and Board[(1+yposition)][(xposition+1)][0]=="" :
                self.k1w.append([(xposition+1)*60,(1+yposition)*60])
            else:
                if (1+yposition)<8 and (xposition+1)<8 and (1+yposition)>-1 and (xposition+1)>-1 and  (1+yposition)>-1 and (xposition+1)>-1 and  (1+yposition)<8 and (xposition+1)<8  and Board[(1+yposition)][(xposition+1)][1]==self.colour or 1+yposition<8 and xposition+1<8 and 1+yposition>-1 and xposition+1>-1 and Board[1+yposition][xposition+1][1]==self.colour2:
                    self.k1w.append([(xposition+1)*60,(1+yposition)*60])                    
            if (yposition-1)<8 and (xposition+1)<8 and (yposition-1)>-1 and (xposition+1)>-1 and (yposition-1)>-1 and (xposition+1)>-1 and  (yposition-1)<8 and (xposition+1)<8  and Board[(yposition-1)][(xposition+1)][0]=="" :
                self.k1w.append([(xposition+1)*60,(yposition-1)*60])
            else:
                if (yposition-1)<8 and (xposition+1)<8 and (yposition-1)>-1 and (xposition+1)>-1 and  (yposition-1)>-1 and (xposition+1)>-1 and  (yposition-1)<8 and (xposition+1)<8  and Board[(yposition-1)][(xposition+1)][1]==self.colour or yposition-1<8 and xposition+1<8 and yposition-1>-1 and xposition+1>-1 and Board[yposition-1][xposition+1][1]==self.colour2:
                    self.k1w.append([(xposition+1)*60,(yposition-1)*60])    
            if (yposition+1)<8 and (xposition-1)<8 and (yposition+1)>-1 and (xposition-1)>-1 and (yposition+1)>-1 and (xposition-1)>-1 and  (yposition+1)<8 and (xposition-1)<8  and Board[(yposition+1)][(xposition-1)][0]=="" :
                self.k1w.append([(xposition-1)*60,(yposition+1)*60])
            else:
...
while run:
    for event in pygame.event.get():
        ...
        if moves==0:
            ...
            Pawn1w11.possible_moves(coords,coords2,"b",moves21,piece,True)
            Pawn2w11=pawnw(coords,coords2,p2wmx,p2wmy,"p2w","b",moves22)
            Pawn2w11.possible_moves(coords,coords2,"b",moves22,piece,True)
            Pawn3w11=pawnw(coords,coords2,p3wmx,p3wmy,"p3w","b",moves23)
            Pawn3w11.possible_moves(coords,coords2,"b",moves23,piece,True)
            Pawn4w11=pawnw(coords,coords2,p4wmx,p4wmy,"p4w","b",moves24)
            Pawn4w11.possible_moves(coords,coords2,"b",moves24,piece,True)
            Pawn5w11=pawnw(coords,coords2,p5wmx,p5wmy,"p5w","b",moves25)
            Pawn5w11.possible_moves(coords,coords2,"b",moves25,piece,True)
            Pawn6w11=pawnw(coords,coords2,p6wmx,p6wmy,"p6w","b",moves26)
            Pawn6w11.possible_moves(coords,coords2,"b",moves26,piece,True)
            Pawn7w11=pawnw(coords,coords2,p7wmx,p7wmy,"p7w","b",moves27)
            Pawn7w11.possible_moves(coords,coords2,"b",moves27,piece,True)
            Pawn8w11=pawnw(coords,coords2,p8wmx,p8wmy,"p8w","b",moves28)
            Pawn8w11.possible_moves(coords,coords2,"b",moves28,piece,True)
        ...
        if moves==1:
            ...
            Pawn1b11.possible_moves(coords,coords2,"w",moves21b,piece,True)
            Pawn2b11=pawnb(coords,coords2,p2bmx,p2bmy,"p2b","w",moves22b)
            Pawn2b11.possible_moves(coords,coords2,"w",moves22b,piece,True)
            Pawn3b11=pawnb(coords,coords2,p3bmx,p3bmy,"p3b","w",moves23b)
            Pawn3b11.possible_moves(coords,coords2,"w",moves23b,piece,True)
            Pawn4b11=pawnb(coords,coords2,p4bmx,p4bmy,"p4b","w",moves24b)
            Pawn4b11.possible_moves(coords,coords2,"w",moves24b,piece,True)
            Pawn5b11=pawnb(coords,coords2,p5bmx,p5bmy,"p5b","w",moves25b)
            Pawn5b11.possible_moves(coords,coords2,"w",moves25b,piece,True)
            Pawn6b11=pawnb(coords,coords2,p6bmx,p6bmy,"p6b","w",moves26b)
            Pawn6b11.possible_moves(coords,coords2,"w",moves26b,piece,True)
            Pawn7b11=pawnb(coords,coords2,p7bmx,p7bmy,"p7b","w",moves27b)
            Pawn7b11.possible_moves(coords,coords2,"w",moves27b,piece,True)
            Pawn8b11=pawnb(coords,coords2,p8bmx,p8bmy,"p8b","w",moves28b)
            Pawn8b11.possible_moves(coords,coords2,"w",moves28b,piece,True)
        ...
        if moves==0:
            if event3.type==pygame.MOUSEBUTTONDOWN and rfv!=1:
                if piece=="":                    
                    ...
                    piece,p1wmx,p1wmy=Pawn1w.possible_moves(coords,coords2,"b",moves21,piece,False)
                    Pawn2w=pawnw(coords,coords2,p2wmx,p2wmy,"p2w","b",moves22)
                    piece,p2wmx,p2wmy=Pawn2w.possible_moves(coords,coords2,"b",moves22,piece,False)
                    Pawn3w=pawnw(coords,coords2,p3wmx,p3wmy,"p3w","b",moves23)
                    piece,p3wmx,p3wmy=Pawn3w.possible_moves(coords,coords2,"b",moves23,piece,False)
                    Pawn4w=pawnw(coords,coords2,p4wmx,p4wmy,"p4w","b",moves24)
                    piece,p4wmx,p4wmy=Pawn4w.possible_moves(coords,coords2,"b",moves24,piece,False)
                    Pawn5w=pawnw(coords,coords2,p5wmx,p5wmy,"p5w","b",moves25)
                    piece,p5wmx,p5wmy=Pawn5w.possible_moves(coords,coords2,"b",moves25,piece,False)
                    Pawn6w=pawnw(coords,coords2,p6wmx,p6wmy,"p6w","b",moves26)
                    piece,p6wmx,p6wmy=Pawn6w.possible_moves(coords,coords2,"b",moves26,piece,False)
                    Pawn7w=pawnw(coords,coords2,p7wmx,p7wmy,"p7w","b",moves27)
                    piece,p7wmx,p7wmy=Pawn7w.possible_moves(coords,coords2,"b",moves27,piece,False)
                    Pawn8w=pawnw(coords,coords2,p8wmx,p8wmy,"p8w","b",moves28)
                    piece,p8wmx,p8wmy=Pawn8w.possible_moves(coords,coords2,"b",moves28,piece,False)
        ...
        if moves==1:
            if event3.type==pygame.MOUSEBUTTONDOWN and rfv!=1:
                if piece=="":
                    ...
                    piece,p1bmx,p1bmy=Pawn1b.possible_moves(coords,coords2,"w",moves21b,piece,False)
                    Pawn2b=pawnb(coords,coords2,p2bmx,p2bmy,"p2b","w",moves22b)
                    piece,p2bmx,p2bmy=Pawn2b.possible_moves(coords,coords2,"w",moves22b,piece,False)
                    Pawn3b=pawnb(coords,coords2,p3bmx,p3bmy,"p3b","w",moves23b)
                    piece,p3bmx,p3bmy=Pawn3b.possible_moves(coords,coords2,"w",moves23b,piece,False)
                    Pawn4b=pawnb(coords,coords2,p4bmx,p4bmy,"p4b","w",moves24b)
                    piece,p4bmx,p4bmy=Pawn4b.possible_moves(coords,coords2,"w",moves24b,piece,False)
                    Pawn5b=pawnb(coords,coords2,p5bmx,p5bmy,"p5b","w",moves25b)
                    piece,p5bmx,p5bmy=Pawn5b.possible_moves(coords,coords2,"w",moves25b,piece,False)
                    Pawn6b=pawnb(coords,coords2,p6bmx,p6bmy,"p6b","w",moves26b)
                    piece,p6bmx,p6bmy=Pawn6b.possible_moves(coords,coords2,"w",moves26b,piece,False)
                    Pawn7b=pawnb(coords,coords2,p7bmx,p7bmy,"p7b","w",moves27b)
                    piece,p7bmx,p7bmy=Pawn7b.possible_moves(coords,coords2,"w",moves27b,piece,False)
                    Pawn8b=pawnb(coords,coords2,p8bmx,p8bmy,"p8b","w",moves28b)
                    piece,p8bmx,p8bmy=Pawn8b.possible_moves(coords,coords2,"w",moves28b,piece,False)
