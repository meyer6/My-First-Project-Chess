    ...
    def possible_moves(self,coords,coords2,colour):
        ...
        if vc=="k1b":
            ...
            if xposition!=9:
                ...
                fc=True
                for i in range (0,len(all_white)-1):
        ...
        if vc=="k1w":
            ...
            if xposition!=9:
                    ...
                    yposition2=yposition*60
                    fc=True
                    for i in range (0,len(all_black)-1):
...
#########################################################################################
            Queen1b2=queen1(q11,q12b,q13b,q14b,q15b,q16b,q17b,q18b,white_protector,"q1b","k1w","w","b")
...
####################################################################
    ####################################################################
            ...
            for i in range (0,len(q21b)):
                if q21b!=[]:
                    all_black.append(q21b[i])
