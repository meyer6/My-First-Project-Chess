...
model = load_model(r'C:\Users\meyer\Desktop\Python\Chess\model')
...
def init_layer_board(fen=False):
    """
...
def decide(board):
    max_move = None
    max_value = np.NINF
    x1 = init_layer_board(fen=board.fen())
    for move in board.legal_moves:
        board.push(move)
        x2 = init_layer_board(fen=board.fen())
        xs = np.reshape([x1, x2], (1,2,8,8,8))
        if board.result() == "1-0":
            max_move = move
            break
        successor_state_value_opponent = model.predict(xs)
...
def position_display(moving,x,y,piece,piece_display):
    if (list_searchy(Board,piece))!=9:
        if moving!=True:
            y=(list_searchy(Board,piece))*60
            x=(list_searchx(Board,piece))*60
...
def board(moving):
    ...
    global p5wmx
    global p5wmy
    r1wmx,r1wmy,r2wmx,r2wmy=(convertx(r1wmx)),(converty(r1wmy)),(convertx(r2wmx)),(converty(r2wmy))
    r1bmx,r1bmy,r2bmx,r2bmy=(convertx(r1bmx)),(converty(r1bmy)),(convertx(r2bmx)),(converty(r2bmy))
    b1wmx,b1wmy,b2wmx,b2wmy=(convertx(b1wmx)),(converty(b1wmy)),(convertx(b2wmx)),(converty(b2wmy))
    b1bmx,b1bmy,b2bmx,b2bmy=(convertx(b1bmx)),(converty(b1bmy)),(convertx(b2bmx)),(converty(b2bmy))
    kn1wmx,kn1wmy,kn2wmx,kn2wmy=(convertx(kn1wmx)),(converty(kn1wmy)),(convertx(kn2wmx)),(converty(kn2wmy))
    kn1bmx,kn1bmy,kn2bmx,kn2bmy=(convertx(kn1bmx)),(converty(kn1bmy)),(convertx(kn2bmx)),(converty(kn2bmy))
    ...
    win.blit(bg,(0,0))
    k1bmx,k1bmy=position_display(moving,k1bmx,k1bmy,"k1b",king_black)
    k1wmx,k1wmy=position_display(moving,k1wmx,k1wmy,"k1w",king_white)
    q1bmx,q1bmy=position_display(moving,q1bmx,q1bmy,"q1b",queen_black)
    q2bmx,q2bmy=position_display(moving,q2bmx,q2bmy,"q2b",queen_black2)
    q3bmx,q3bmy=position_display(moving,q3bmx,q3bmy,"q3b",queen_black3)
    q4bmx,q4bmy=position_display(moving,q4bmx,q4bmy,"q4b",queen_black4)
    r1bmx,r1bmy=position_display(moving,r1bmx,r1bmy,"r1b",rook_black1)
    r2bmx,r2bmy=position_display(moving,r2bmx,r2bmy,"r2b",rook_black2)
    b1bmx,b1bmy=position_display(moving,b1bmx,b1bmy,"b1b",bishop_black1)
    b2bmx,b2bmy=position_display(moving,b2bmx,b2bmy,"b2b",bishop_black2)
    kn1bmx,kn1bmy=position_display(moving,kn1bmx,kn1bmy,"kn1b",knight_black1)
    kn2bmx,kn2bmy=position_display(moving,kn2bmx,kn2bmy,"kn2b",knight_black2)
    p1bmx,p1bmy=position_display(moving,p1bmx,p1bmy,"p1b",pawn_black1)
    p2bmx,p2bmy=position_display(moving,p2bmx,p2bmy,"p2b",pawn_black2)
    p3bmx,p3bmy=position_display(moving,p3bmx,p3bmy,"p3b",pawn_black3)
    p4bmx,p4bmy=position_display(moving,p4bmx,p4bmy,"p4b",pawn_black4)
    p5bmx,p5bmy=position_display(moving,p5bmx,p5bmy,"p5b",pawn_black5)
    p6bmx,p6bmy=position_display(moving,p6bmx,p6bmy,"p6b",pawn_black6)
    p7bmx,p7bmy=position_display(moving,p7bmx,p7bmy,"p7b",pawn_black7)
    p8bmx,p8bmy=position_display(moving,p8bmx,p8bmy,"p8b",pawn_black8)
    q1wmx,q1wmy=position_display(moving,q1wmx,q1wmy,"q1w",queen_white)
    q2wmx,q2wmy=position_display(moving,q2wmx,q2wmy,"q2w",queen_white2)
    q3wmx,q3wmy=position_display(moving,q3wmx,q3wmy,"q3w",queen_white3)
    q4wmx,q4wmy=position_display(moving,q4wmx,q4wmy,"q4w",queen_white4)
    r1wmx,r1wmy=position_display(moving,r1wmx,r1wmy,"r1w",rook_white1)
    r2wmx,r2wmy=position_display(moving,r2wmx,r2wmy,"r2w",rook_white2)
    b1wmx,b1wmy=position_display(moving,b1wmx,b1wmy,"b1w",bishop_white1)
    b2wmx,b2wmy=position_display(moving,b2wmx,b2wmy,"b2w",bishop_white2)
    kn1wmx,kn1wmy=position_display(moving,kn1wmx,kn1wmy,"kn1w",knight_white1)
    kn2wmx,kn2wmy=position_display(moving,kn2wmx,kn2wmy,"kn2w",knight_white2)
    p1wmx,p1wmy=position_display(moving,p1wmx,p1wmy,"p1w",pawn_white1)
    p2wmx,p2wmy=position_display(moving,p2wmx,p2wmy,"p2w",pawn_white2)
    p3wmx,p3wmy=position_display(moving,p3wmx,p3wmy,"p3w",pawn_white3)
    p4wmx,p4wmy=position_display(moving,p4wmx,p4wmy,"p4w",pawn_white4)
    p5wmx,p5wmy=position_display(moving,p5wmx,p5wmy,"p5w",pawn_white5)
    p6wmx,p6wmy=position_display(moving,p6wmx,p6wmy,"p6w",pawn_white6)
    p7wmx,p7wmy=position_display(moving,p7wmx,p7wmy,"p7w",pawn_white7)
    p8wmx,p8wmy=position_display(moving,p8wmx,p8wmy,"p8w",pawn_white8)
...
def all_white_append(piece_attack,all_white):
    ...
    return all_white
def piece_place(moving,piece,b1wmx,b1wmy,hb,white_check,moves,rfv,coords,coords2,vc,piece2,class_piece,moves2r1w):
    if piece==piece2:
    ...
    return moving,piece,b1wmx,b1wmy,hb,white_check,moves,rfv,coords,coords2,vc,class_piece,moves2r1w
def piece_place_pawn(moving,piece,b1wmx,b1wmy,hb,white_check,moves,rfv,coords,coords2,vc,piece2,class_piece,pawn_2_spaces_move,moves21):
    if piece==piece2:
        b1wmx,b1wmy=pygame.mouse.get_pos()
        ...
        if tg==3 or tg==2 or tg==1:
            coords,coords2,piece,rfv,b1wmx,b1wmy=[],[],"",1,(list_searchx(Board,vc))*60,(list_searchy(Board,vc))*60
    return moving,piece,b1wmx,b1wmy,hb,white_check,moves,rfv,coords,coords2,vc,class_piece,pawn_2_spaces_move,moves21
...
while run:
    for event in pygame.event.get():
        ...
        if moves==0:
                ...
                for a in range (7,-1,-1):
                    if Board[i][a][0]!="":
                        ...
                        if (Board[i][a][0])[0]=="b" and Board[i][a][1]=="w":
                            ...
                            if (Board[i][a][0])[1]=="n" and Board[i][a][1]=="w":
                                fen=fen+"N"
                            else:
                                fen=fen+"K"
                        elif (Board[i][a][0])[0]=="k" and Board[i][a][1]=="b":
                            if (Board[i][a][0])[1]=="n" and Board[i][a][1]=="b":
                                fen=fen+"n"
                            else:
                                fen=fen+"k"
                    else:
            ...
            best_move=decide(chess.Board(fen))
            print(best_move)
            if best_move==None:
                Continue=False
            if Continue==True:
                best_move=str(best_move)
                readable_best_move=((ord(best_move[0])-97))*1000+((int(best_move[1]))-1)*100+((ord(best_move[2])-97))*10+(int(best_move[3])-1)
                best_move=str(readable_best_move)
                for i in range(0,5):
                    if len(best_move)<=3:
                        best_move="0"+best_move
                hb=0
                moves=moves+1
                if Board[int(best_move[1])][int(best_move[0])][0]=="r1w":
                    moves2r1w=moves2r1w+1
                if Board[int(best_move[1])][int(best_move[0])][0]=="r2w":
                    moves2r2w=moves2r2w+1
                if Board[int(best_move[1])][int(best_move[0])][0]=="k1w":    
                    moves2kb=moves2kb+1
                vc=Board[(int(best_move[1]))][int(best_move[0])][0]
                if vc[0]=="p" and best_move[3]=="7":
                    queen_spawn=queen_spawn+1
                    Board[int(best_move[3])][int(best_move[2])][0]="q"+str(queen_spawn)+"w"
                    Board[int(best_move[3])][int(best_move[2])][1]="w"
                    Board[int(best_move[1])][int(best_move[0])][0]=""
                    Board[int(best_move[1])][int(best_move[0])][1]=""
                else:
                    Board[int(best_move[3])][int(best_move[2])][0]=vc
                    Board[int(best_move[3])][int(best_move[2])][1]="w"
                    Board[int(best_move[1])][int(best_move[0])][0]=""
                    Board[int(best_move[1])][int(best_move[0])][1]=""
                board(moving)
        ...
        if moves==1:
            ...
            if piece!="":
                moving=True
                moving,piece,b1bmx,b1bmy,hw,black_check,moves,rfv,coords,coords2,vc,Bishop1b,moves2r1w=piece_place(moving,piece,b1bmx,b1bmy,hw,black_check,moves,rfv,coords,coords2,"b1b","bishop1b",Bishop1b,moves2r1w)
                moving,piece,b2bmx,b2bmy,hw,black_check,moves,rfv,coords,coords2,vc,Bishop2b,moves2r1w=piece_place(moving,piece,b2bmx,b2bmy,hw,black_check,moves,rfv,coords,coords2,"b2b","bishop2b",Bishop2b,moves2r1w)
                moving,piece,kn1bmx,kn1bmy,hw,black_check,moves,rfv,coords,coords2,vc,Knight1b,moves2r1w=piece_place(moving,piece,kn1bmx,kn1bmy,hw,black_check,moves,rfv,coords,coords2,"kn1b","knight1b",Knight1b,moves2r1w)
                moving,piece,kn2bmx,kn2bmy,hw,black_check,moves,rfv,coords,coords2,vc,Knight2b,moves2r1w=piece_place(moving,piece,kn2bmx,kn2bmy,hw,black_check,moves,rfv,coords,coords2,"kn2b","knight2b",Knight2b,moves2r1w)
                moving,piece,r1bmx,r1bmy,hw,black_check,moves,rfv,coords,coords2,vc,Rook1b,moves2r1b=piece_place(moving,piece,r1bmx,r1bmy,hw,black_check,moves,rfv,coords,coords2,"r1b","rook1b",Rook1b,moves2r1b)
                moving,piece,r2bmx,r2bmy,hw,black_check,moves,rfv,coords,coords2,vc,Rook1b,moves2r2b=piece_place(moving,piece,r2bmx,r2bmy,hw,black_check,moves,rfv,coords,coords2,"r2b","rook2b",Rook2b,moves2r2b)
                moving,piece,q1bmx,q1bmy,hw,black_check,moves,rfv,coords,coords2,vc,Queen1b,moves2r1w=piece_place(moving,piece,q1bmx,q1bmy,hw,black_check,moves,rfv,coords,coords2,"q1b","queen1b",Queen1b,moves2r1w)
                moving,piece,q2bmx,q2bmy,hw,black_check,moves,rfv,coords,coords2,vc,Queen2b,moves2r1w=piece_place(moving,piece,q2bmx,q2bmy,hw,black_check,moves,rfv,coords,coords2,"q2b","queen2b",Queen2b,moves2r1w)
                moving,piece,q3bmx,q3bmy,hw,black_check,moves,rfv,coords,coords2,vc,Queen3b,moves2r1w=piece_place(moving,piece,q3bmx,q3bmy,hw,black_check,moves,rfv,coords,coords2,"q3b","queen3b",Queen3b,moves2r1w)
                moving,piece,q4bmx,q4bmy,hw,black_check,moves,rfv,coords,coords2,vc,Queen4b,moves2r1w=piece_place(moving,piece,q4bmx,q4bmy,hw,black_check,moves,rfv,coords,coords2,"q4b","queen4b",Queen4b,moves2r1w)
                
                moving,piece,p1bmx,p1bmy,hw,black_check,moves,rfv,coords,coords2,vc,Pawn1b,pawn_2_spaces_move,moves21b=piece_place_pawn(moving,piece,p1bmx,p1bmy,hw,black_check,moves,rfv,coords,coords2,"p1b","pawn1b",Pawn1b,pawn_2_spaces_move,moves21b)
                moving,piece,p2bmx,p2bmy,hw,black_check,moves,rfv,coords,coords2,vc,Pawn2b,pawn_2_spaces_move,moves22b=piece_place_pawn(moving,piece,p2bmx,p2bmy,hw,black_check,moves,rfv,coords,coords2,"p2b","pawn2b",Pawn2b,pawn_2_spaces_move,moves22b)
                moving,piece,p3bmx,p3bmy,hw,black_check,moves,rfv,coords,coords2,vc,Pawn3b,pawn_2_spaces_move,moves23b=piece_place_pawn(moving,piece,p3bmx,p3bmy,hw,black_check,moves,rfv,coords,coords2,"p3b","pawn3b",Pawn3b,pawn_2_spaces_move,moves23b)
                moving,piece,p4bmx,p4bmy,hw,black_check,moves,rfv,coords,coords2,vc,Pawn4b,pawn_2_spaces_move,moves24b=piece_place_pawn(moving,piece,p4bmx,p4bmy,hw,black_check,moves,rfv,coords,coords2,"p4b","pawn4b",Pawn4b,pawn_2_spaces_move,moves24b)
                moving,piece,p5bmx,p5bmy,hw,black_check,moves,rfv,coords,coords2,vc,Pawn5b,pawn_2_spaces_move,moves25b=piece_place_pawn(moving,piece,p5bmx,p5bmy,hw,black_check,moves,rfv,coords,coords2,"p5b","pawn5b",Pawn5b,pawn_2_spaces_move,moves25b)
                moving,piece,p6bmx,p6bmy,hw,black_check,moves,rfv,coords,coords2,vc,Pawn6b,pawn_2_spaces_move,moves26b=piece_place_pawn(moving,piece,p6bmx,p6bmy,hw,black_check,moves,rfv,coords,coords2,"p6b","pawn6b",Pawn6b,pawn_2_spaces_move,moves26b)
                moving,piece,p7bmx,p7bmy,hw,black_check,moves,rfv,coords,coords2,vc,Pawn7b,pawn_2_spaces_move,moves27b=piece_place_pawn(moving,piece,p7bmx,p7bmy,hw,black_check,moves,rfv,coords,coords2,"p7b","pawn7b",Pawn7b,pawn_2_spaces_move,moves27b)
                moving,piece,p8bmx,p8bmy,hw,black_check,moves,rfv,coords,coords2,vc,Pawn8b,pawn_2_spaces_move,moves28b=piece_place_pawn(moving,piece,p8bmx,p8bmy,hw,black_check,moves,rfv,coords,coords2,"p8b","pawn8b",Pawn8b,pawn_2_spaces_move,moves28b)
            if piece=="king1b":
                k1bmx,k1bmy=pygame.mouse.get_pos()
